...
// Validation schema for upgrade - using strings for flexible types
const upgradeSchema = z.object({
  ...
  liquidity_taken_against_bias: z.enum(['Yes', 'No']).optional(),
  ...
  entry_candle: z.string().optional(),
  ...
  entry_precision: z.string().optional(),
  stop_placement_quality: z.string().optional(),
  partial_taken: z.enum(['Yes', 'No']).optional(),
  rules_followed: z.enum(['Yes', 'No'], { required_error: 'Required' }),
  gold_behavior_tags: z.array(z.string()).default([]),
  first_move_was_fake: z.enum(['Yes', 'No']).optional(),
  real_move_after_liquidity: z.enum(['Yes', 'No']).optional(),
  trade_aligned_with_real_move: z.enum(['Yes', 'No']).optional(),
  pre_trade_state: z.string().optional(),
  confidence_level: z.number().min(1).max(5).optional(),
  revenge_trade: z.enum(['Yes', 'No']).optional(),
  fatigue_present: z.enum(['Yes', 'No']).optional(),
  htf_screenshot: z.string().optional(),
  ltf_entry_screenshot: z.string().optional(),
  post_trade_screenshot: z.string().optional(),
  annotations_present: z.enum(['Yes', 'No']).optional(),
